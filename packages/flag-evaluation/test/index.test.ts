...
describe("evaluate flag targeting integration ", () => {
  ...
  it.each([
    ...
    async ({ context, expected }) => {
      ...
      const res = evaluator(context, "flag");
  ...
  describe("DATE_AFTER and DATE_BEFORE in flag rules", () => {
    ...
    it("should handle complex rules with DATE_AFTER and DATE_BEFORE in groups in flag rules", () => {
      const res = evaluateFlagRules({
    ...
    it("should fail when DATE_AFTER condition is not met in flag rules", () => {
      const res = evaluateFlagRules({
        flagKey: "future_flag",
        rules: [
          {
    ...
    it("should fail when DATE_BEFORE condition is not met in flag rules", () => {
      const res = evaluateFlagRules({
        flagKey: "past_flag",
        rules: [
          {
    ...
    it("should work with optimized evaluator in flag rules", () => {
      const evaluator = newEvaluator([
        {
