...
export class LiveSatisfaction {
  constructor(
    ...
    private sseChannel: AblySSEConn,
  ) {
    this.sseChannel.addOnMessageCallback(
      "feedback_prompt",
